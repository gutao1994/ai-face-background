...
class FaceLogic
{
    ...
    protected function female10()
    {
        if ($this->beauty >= 70) { //颜值高
            ...
            $this->result = '你是一个性格较为外向且活泼好动的小女孩，你的笑容非常具有感染力，当父母在外辛苦劳累一天，回家后看到你那纯洁质朴的笑容，身上的疲劳就会一扫而空。你有着比同龄人更加灵敏的反应能力，也比同龄人对未知事物有着更加强烈的好奇心，';
            $this->result .= '如果家长能够合适地引导孩子的好奇心，给孩子培养出一个正确的兴趣爱好， 你未来的人生会有福气相伴，不会有大灾大难，会有一个顺遂的人生之路。';
