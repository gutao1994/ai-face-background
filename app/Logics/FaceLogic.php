...
class FaceLogic
{
    ...
    protected function female26()
    {
        if ($this->beauty >= 75) { //颜值高
            ...
            $this->result = '在性格上，你是属于乐天派这一类型的女生，你乐于享受当下，懂得知足常乐，因此总是能够快乐相伴、少烦恼。你也是一个心胸宽广的女生，你不喜欢为一些小事而与人斤斤计较，平日里待人也很诚恳友善且乐于助人，容易与他人相处，因此人际关系会较好，';
            $this->result .= '有几个玩得很好且能交心的闺蜜好友。你意志力不是很强，自控能力较弱，做事情往往是三分钟热度，未来在事业上的运势较为一般，不易在事业上有所作为，但是整体的运势却是较为不错，尤其是在婚姻上会很有福气，婚姻生活会非常顺遂如意。';
            ...
            $this->result = '你是一个非常聪明伶俐的女生，你有着比同龄人更强的学习能力， 事业心强 对待感情坚定如一，懂得安分守己，能够忍得住外界的诱惑 ';
            $this->result .= '';
        } else {
