...
class FaceLogic
{
    ...
    {
        if ($this->faceupResult == 'faceup_long') { //上庭偏长
            $this->result = '从你的面相上来看，你中年时的事业运势会比较好，届时在事业上会比较成功，能够在事业上取得一番不错的成就，而且财运也会不错。你很明确自己的目标，能把握自己未来的方向，知道自己想要什么。你也特别懂得如何去跟别人打交道，';
            $this->result .= '因此你的人际关系会比较好，也更容易能够得到贵人相助，贵人运会较为不错。在个人感情上，你的情感道路会比较一帆风顺，会与你相爱之人有一个幸福的家庭。你的妻子会是你的贤内助，在你打拼事业的路上，默默地支持你，做你背后的女人。';
        } elseif ($this->beauty >= 80) { //颜值非常高
            $this->result = '你是一个颜值非常高、非常容易惹人注目的男生，很多男明星的颜值甚至都比不过你。走在大街上，你绝对能够收获到无数的回头率，很多女生看了你一眼，都会忍不住再看第二眼。你的异性缘也特别好，而且总是能够收到很多异性的表白，';
            $this->result .= '这对于其他男生来说是非常令人羡慕的，但是很多时候却会给你造成一定的困扰。相比于一般的男生，你在男女关系上有着更大的优势，如果你想要收获一份真正的爱情，就得学会放弃这份双方关系中的优越感，并且做到真心投入，这样才能够修成爱情的正果。';
        } elseif ($this->eyebrowType == 'eight_eyebrows' || $this->eyesType == 'thin_eyes' || $this->eyesType == 'small_eyes' || $this->faceType == 'long_face') { //八字眉 细长眼 小眼 长形脸
            $this->result = '你是一个性格温和、脾气好、品德好的人，表面上好像给人一种不易接近的感觉，实际上是一个非常平易近人、待人为善、很好相处的人。你在追求自己喜欢的女孩子的时候会不予余力，但也懂得不去过分迎合，在与异性交往之后能够专心致志、一心一意，';
            $this->result .= '除此之外，在平时生活中你也能够做到体贴与温柔，甚至无微不至。你结婚后会"怕老婆"，事事都以老婆大人为上，赚来的钱财也会上交给老婆去保管，是属于好好先生的类型，但同时你的异性情缘也会很好，这点可能会另你的爱人有点头疼。';
            ...
            $this->result = '你是一个内心强大、性格刚毅、做事果断、说话直爽的男人，你有着很强的抗压能力，不会畏惧任何困难，即使是遇到再困难的事情，你也会一步一步地走过去，即使这个过程非常地艰辛。你也是一个非常有魄力、有担当、不畏惧失败的人，在事业上也敢闯敢拼、';
            $this->result .= '不怕苦不怕累，因此经过长时间的积累之后，到中晚年时，你定然会成为一个能够独当一面的强人，在事业上也能取得一番不错的成就。你还是一个对婚姻非常忠诚的人，虽然你的感情生活会较为平淡，不会很丰富多彩，但是你的婚姻生活却会幸福和睦、令人羡慕。';
        } elseif ($this->mouthType == 'thick_lip') { //厚唇
            $this->result = '你是一个性格较为随和的人，你为人忠厚老实并且待人诚恳，做事情能够脚踏实地、一步一个脚印，是个让人感觉非常踏实可靠的人。你的个人运势也比较不错，到中年或者中晚年的时候，能够厚积薄发，在事业上取得一定的成绩。';
            $this->result .= '更令人羡慕的是，你还是个旺妻命。在你结婚之后，你会给你的妻子带来很多帮助和好运，尤其是在事业上的好运。嫁给你这样的男人，你的妻子在以后的日子里，会过得富裕、舒心、且幸福。';
        } elseif ($this->noseType == 'thick_nose') { //宽鼻
            $this->result = '你是一个做事能够果断、专注，办事效率高，并且不会轻言放弃的人，无论什么事情，只要去做，就不会轻易地放弃，会坚持到底。在工作上是如此，在感情上更是如此。在感情上，你是一个对待感情认真且非常执着的人，';
            $this->result .= '婚前，与异性交往不会轻易地说分手；婚后，对婚姻的忠诚度非常高，你要的是天长地久，而不仅仅只是曾经拥有。在性格上，你是一个比较外向、开朗、随和、待人热情的人，因此你的人缘也比较不错，是一个比较受欢迎的人。';
        } else {
    ...
    {
        if ($this->beauty >= 75) { //颜值高
            $this->result = '你是一个魅力十足的女生，你的颜值很高，容易让人过目不忘，对异性有着很大的吸引力和杀伤力，很多异性会主动接近你，你的身边从来都不乏追求者。你对待感情非常认真谨慎，在与异性交往前，你会仔细地去考量对方的人品性格，';
            $this->result .= '不会轻易草率地与人交往。一旦确定与异性交往，你能够做到专一与一心一意，对于其他异性的邀约，你也知道合理地去拒绝。你未来的婚姻也会比较幸福，能够和一个爱你、懂得呵护、疼惜你的人结婚，婚姻生活会过得甜甜蜜蜜，令人羡慕。';
        } elseif ($this->faceType == 'square_face' || $this->jawType == 'square_jaw') { // 方形脸 方下巴
            $this->result = '你是一个性格沉稳、略微带点强势的女生。与其他女生不同的是，在工作事业上，你是一个比较有自己的想法、有自己的目标的人。你的办事能力较强，做事总是有条不紊且效率高，对于工作勇于负责，肯吃苦耐劳，未来在事业上很有可能会做出一番成就，';
            $this->result .= '很多男性都比不过你。在婚姻上，建议你找一个顾家、有家庭责任感、老实本分的男人结婚，这样你们在性格上就能够做到相互弥补、互相补充，你们的家庭生活就会过得和和美美，小日子也会越来越滋润。';
        } elseif ($this->mouthType == 'smile_lip' || $this->emotion == 'happiness' || $this->smile) { //微笑唇 高兴的情绪 有笑容
            ...
            $this->result = '在性格上，你是属于乐天派这一类型的女生，你乐于享受当下，懂得知足常乐，因此总是能够快乐相伴、少烦恼。你也是一个心胸宽阔的女生，你不喜欢为一些小事而与人斤斤计较，平日里待人也很诚恳友善且乐于助人，容易与他人相处，因此人际关系会较好，';
            $this->result .= '有几个玩得很好且能交心的闺蜜好友。你意志力不是很强，自控能力较弱，做事情往往是三分钟热度，未来在事业上的运势较为一般，不易在事业上有所作为，但是你整体的运势却是较为不错，尤其是在婚姻上会很有福气，婚姻生活会非常顺遂如意。';
        } elseif (in_array($this->eyebrowType, ['straight_eyebrows', 'arch_eyebrows']) || $this->eyesType == 'round_eyes') { //一字眉 柳叶眉 圆眼
            ...
            $this->result = '你是一个有智慧、有才华且非常聪明伶俐的女生，你的头脑灵活，思维敏捷，并且有着比同龄人更强的学习能力。你懂得规划自己的未来，有着自己的一番理想，会在人生的不同阶段给自己设立不同的目标，从而不断地挑战自我、超越自我，';
            $this->result .= '你未来的人生必定会非常地精彩绝伦。在婚姻爱情方面，你的正缘会来的比一般人稍晚，但是你不必为此过分焦虑，因为经得起时间考验与筛选的人，虽然姗姗来迟，却是个能够相濡以沫且值得相伴一生的人。';
        } else {
    ...
    {
        if ($this->faceupResult == 'faceup_long') { //上庭偏长
            $this->result = '你是一个非常聪明且很有才华的男人，你的性格非常好，平时待人非常友善且平易近人，因此身边的朋友会比较多，人缘也比较好。在事业上，你是一个很有事业心的人，对待工作认真负责，肯拼搏、肯奋进，在事业上会取得较高的成就。';
            $this->result .= '你的财运也比较旺盛，在以后的人生中，只要不乱花钱、不挥霍，基本不会缺钱花，是一个富贵命。感情上，你基本不会遇到什么挫折磕绊，与爱人间的关系能够平稳和睦，未来也会携手相伴一生，家庭生活会比较幸福美满。';
        } elseif ($this->eyesType == 'thin_eyes' || $this->eyesType == 'small_eyes' || $this->noseType == 'thin_nose') { //细长眼 小眼 窄鼻
            $this->result = '你是一个喜欢思考、并且善于思考的人。你做事情往往能够深谋远虑、未雨绸缪，很多事情能够做到防患于未然，即使在工作上出现问题的时候，你往往也能快速地找到合适的解决办法，所以会给身边人一种非常靠谱的感觉。';
            $this->result .= '同时你也不是一个随性的人，不管是在工作还是生活中，你都是一个很有责任感的人。在对待感情上，你是一个非常专一、不容易被身边花花绿绿的人或事所诱惑的人，因此你的爱人会对你比较放心，你的家庭氛围也会较为和睦。';
        } elseif ($this->faceType == 'round_face') { //圆形脸
            $this->result = '你的面相是一个有福之相，在未来的人生中，基本上不会遇到太多的风雨坎坷，一生的运势都会比较好。你的性格温和，为人乐观，做事实在，平时人缘也较好，而且有贵人运。在接下来的几年里，如果能够继续勤勤恳恳工作，在自己的岗位上做到尽心尽责，';
            $this->result .= '那么很有可能会有贵人给你带来好运，到时你的财运会非常旺盛，以后的人生中基本上不会再为钱财发愁。在感情上，你是一个懂得爱护妻子的人，你的妻子会是你生活和事业上的好帮手，你的家庭生活也会较为美满，令人羡慕。';
        } elseif ($this->glabellaWrinkle == 1 || $this->faceType == 'square_face') { //有眉间纹 方形脸
            $this->result = '你是个性格稳重、为人靠谱、做事踏实的人。你做事情从来都不会急于求成，因为你知道急急忙忙反而容易出错、适得其反，所以每次都能够很好地完成工作上的任务。你也是个喜欢学习并且很注重提升自己能力的人，这让你在职场上始终能够保持非常强大的竞争力，';
            $this->result .= '你不会害怕失业，所谓的中年焦虑根本无法影响到你。你还是个非常热心的人，当别人遇到问题或者向你请教问题的时候，你都会非常耐心地提供帮助，这使得你的人缘也比较好，良好的人际关系会让你以后的人生道路越走越宽。';
        } elseif ($this->mouthType == 'thick_lip') { //厚唇
            $this->result = '你喜欢说理式的表达，在与人探讨交流时，你的表情与肢体动作时常会流露出充满理性的气息，这对于一些异性来说，是非常有魅力与吸引力的。你的这种理性、冷静的形象气质，会让她们在倾倒之余，还能增加对你的信服度。你也非常善于处理工作上棘手的问题，';
            $this->result .= '当其他人面对问题不知所措的时候，你却能够给出一个不错的解决方案，因此你更加能够受到上级的器重，很多有挑战性的任务也会交给你来执行，这也让你有着比一般人更多的机遇，如果能够把握好机会，你也能够在事业上取得一番不错的成绩。';
        } else {
            $this->result = '你是一个有家庭责任心的男人。在外工作，你能够勤勤恳恳、尽心尽力；回到家里，你懂得扛起家庭的重担，帮助妻子处理家务，对家庭尽你该尽的义务，因此你的家庭氛围会比较和睦。你对老婆也非常疼爱，是一个懂得照顾、爱护妻子的人，';
            $this->result .= '而且凡事都能够为对方着想，因此对于女人来说，你是一个值得托付终生的人。你的晚年生活会比较平平稳稳，不会有太多的坎坎坷坷，会有一个比较安稳幸福的晚年，而且届时能够子孙满堂，享尽天伦之乐。';
        }
    ...
    {
        if ($this->beauty >= 75) { //颜值高
            $this->result = '你的面相贵气逼人，属于雍容富贵之相，并且天生就带有旺夫运，能够为丈夫的事业带来好运。你自身的财运也特别好，自己有钱的同时也愿意用自己的财力帮助他人，因此人缘也会特别好。性格上，你是一个非常善解人意的人，别人和你相处的时候，';
            $this->result .= '会感觉轻松自在，不会有压迫感。你以后的人生也会较为顺风顺水，身体上会很少生病，会有一个安逸、幸福且快乐的人生。而且你带有多子多福之相，在后代生养问题上，你是可以少操心的，孩子也会聪明、健康、乖顺、懂事、成长顺利，学业也不错。';
        } elseif (in_array($this->eyebrowType, ['raise_eyebrows', 'round_eyebrows', 'arch_eyebrows'])) { //上挑眉 拱形眉 柳叶眉
            $this->result = '你是个脾气好、性格温和善良、看重感情、体贴贤惠的女人。你的面相自带福气，自身财运较好，会赚钱、会花钱，基本上不会为钱财发愁。在婚姻上，能够嫁给一个实力强劲、对自己好的男人，结婚以后家庭生活能够幸福美满，小日子会过得很安逸，';
            $this->result .= '有人疼有人爱，是属于比较好命的女人。你的人缘也比较好，在平时生活中，你为人大度，待人诚恳，不爱与人斤斤计较，与人交往具有包容心，往往会给人一种如沐春风的感觉，因此大家都很愿意与你来往，并且在你有困难的时候都愿意帮助你。';
        } elseif ($this->noseType == 'thick_nose' || $this->faceType == 'square_face' || $this->jawType == 'square_jaw') { //宽鼻 方形脸 方下巴
            $this->result = '你是一个有智慧、有头脑、有才华的女人。你为人处事大方得体，做事认真负责，聪明能干，学习能力强，既有实力又有能力。你擅长与人沟通交流，通常人际关系不错，身边贵人也多，在事业上容易得到贵人的帮助，因此财运往往也比较好。';
    ...
    {
        if ($this->mouthType == 'thick_lip') { //厚唇
            $this->result = '你是一个性格随和、宽厚的人。在与人相处时，你总是能够做到真诚以待，因此你的人际关系也比较好。在对待自己的事业上，你是一个努力奋斗、积极向上、踏实肯干的人，因此你的工作伙伴都很乐意与你一起共事。';
            $this->result .= '你中晚年的运势会很好，是属于晚年大发的类型，届时将会时来运转，迎来自己事业上的巅峰。在家庭方面，你的家庭生活会和和美美，你与你爱人的关系也是较为和睦，不会在感情上有太多坎坷磨难。';
        } elseif ($this->faceType == 'round_face') { //圆形脸
            $this->result = '你的面相看起来特别地有福气，是属于比较典型的福气相。你的早年家境较为贫寒，吃过很多苦，但后面经过自己一步步多年地努力打拼，也拥有了一份属于自己的事业，慢慢地积累了不少的财富，生活上会过得比较不错。';
            $this->result .= '你平时待人都是乐呵呵的，性格也比较好，也非常善于处理自己的情绪，不易与人发生矛盾冲突，有几个关系不错、能够相互帮扶的朋友。在以后的人生中，只要能够做到稳扎稳打、不乱折腾，基本上不会再经历什么坎坷。';
        } elseif ($this->jawType == 'square_jaw') { //方下巴
            ...
            $this->result .= '做事情往往能够善始善终，不会轻易罢手、轻言放弃。一旦遇到事业上的挫折时，总能轻松应对，愈挫愈勇。岁月的磨砺，赋予了你足够的智慧与才能，让你在今后的人生中，能够越行越稳，越走越顺。';
        }
    ...
    protected function female50()
    {
        if ($this->beauty >= 70) { //颜值高
        ...
        } elseif ($this->faceType == 'oval_face') { //椭圆脸
            ...
            $this->result = '你是个很能理解和体谅别人、没什么心机、性格豁达且淡然的人。在平时生活中，你是个很好相处、并且相处起来能够令人感到很舒服的人。你待人热情大方，愿意与朋友分享自己的喜乐，因此身边总是会有很多玩得好的闺蜜朋友。';
            $this->result .= '在家庭上，你是个热爱家庭、肯为了家庭的安稳和幸福做出牺牲的人，因此你的家庭生活能够较为和美，夫妻之间能够互相恩爱、敬重，在往后的漫漫岁月里，能够一起携手度过一个幸福、安稳、有乐趣的人生。';
    ...
    protected function femaleInf()
    {
        ...
        } elseif ($this->skinStatus['health'] >= 60) { //面部特征健康
